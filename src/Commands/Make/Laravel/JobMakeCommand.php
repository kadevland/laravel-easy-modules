...
/**
 * Command to create job classes within modules.
 *
 * This command extends Laravel's base JobMakeCommand to generate
 * jobs within the modular structure, supporting all Laravel
 * options like --sync for queue processing in the infrastructure layer.
 *
...
class JobMakeCommand extends BaseJobMakeCommand
{
     ...
     * @var string
     */
    protected string $componentType = 'job';
     ...
     * @var string
     */
    protected $name = 'easymodules:make-job';
     ...
     * @var string
     */
    protected $description = 'Create a new job class within a module';
    ...
    {
        $this->configureModuleAliases('make-job');
        parent::configure();
    }
    ...
    {
        return $this->moduleNamespace($this->getComponentType(), 'Infrastructure\\Jobs');
    }
}
